  ...
  return (
    <section className="w-full max-w-2xl px-6 py-4 mx-auto bg-white rounded-md shadow-md dark:bg-gray-800 my-10">
      <h2 className="text-3xl font-semibold text-center text-gray-800 dark:text-white">
        Get in touch With Dhamija Jobs
      </h2>
      <p className="mt-3 text-center text-gray-600 dark:text-gray-400">
        We work for freashers and experienced people to get their dream jobs
      </p>
      ...
      <div className="grid grid-cols-1 gap-6 mt-6 sm:grid-cols-2 md:grid-cols-3">
        ...
        >
          ...
          <span className="mt-2">+9999999</span>
        </a>
        ...
        >
          ...
          <span className="mt-2">dhamija@jobs.com</span>
        </a>
      </div>
      ...
      <div className="mt-6 ">
        ...
        <div className="flex justify-center mt-6">
          <button className="px-4 py-2 text-white transition-colors duration-200 transform bg-primary rounded-md hover:bg-gray-600 focus:outline-none focus:bg-gray-600">
            Send Message
          </button>
        </div>
      </div>
